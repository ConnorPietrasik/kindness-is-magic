 ...
 */
export const TableBody = memo(({ children }: TableBodyProps) => <tbody className="divide-y divide-gray-100">{children}</tbody>);
 ...
 * Tr — body row.
 */
export const Tr = forwardRef<HTMLTableRowElement, TrProps>(function Tr({ className = "", children, ...props }, ref) {
  return (
