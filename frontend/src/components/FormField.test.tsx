...
describe('FormField', () => {
  ...
  it('renders label with correct text and htmlFor', () => {
    render(
      <FormField label="Email" htmlFor="email" fieldProps={{ name: 'email' }} />,
    );
  ...
  it('auto-generates id when htmlFor is not provided', () => {
    const { container } = render(
      <FormField label="Name" fieldProps={{ name: 'name' }} />,
    );
  ...
  it('uses explicit htmlFor when provided', () => {
    const { container } = render(
      <FormField label="Name" htmlFor="my-name" fieldProps={{ name: 'name' }} />,
    );
  ...
  it('hides label when label prop is falsy', () => {
    const { container } = render(
      <FormField fieldProps={{ name: 'hidden' }} />,
    );
  ...
  it('renders input by default with type="text"', () => {
    const { container } = render(
      <FormField label="Text" fieldProps={{ name: 'text' }} />,
    );
  ...
  it('renders textarea when as="textarea"', () => {
    const { container } = render(
      <FormField label="Notes" as="textarea" fieldProps={{ name: 'notes' }} />,
    );
  ...
  it('does not apply type attribute to textarea', () => {
    const { container } = render(
      <FormField label="Notes" as="textarea" type="text" fieldProps={{ name: 'notes' }} />,
    );
  ...
  it('renders input with custom type', () => {
    const { container } = render(
      <FormField label="Email" type="email" fieldProps={{ name: 'email' }} />,
    );
  ...
  it('passes through fieldProps to the input element', async () => {
    render(
      <FormField
        label="Username"
        htmlFor="username"
        fieldProps={{ name: 'username', placeholder: 'Enter name', required: true }}
      />,
    );
  ...
  it('supports controlled input behavior', async () => {
    ...
    render(
      <FormField
        label="Value"
        htmlFor="val"
        fieldProps={{ name: 'val', value: 'hello', onChange: () => {} }}
      />,
    );
  ...
  it('applies extra className from fieldProps alongside base classes', () => {
    const { container } = render(
      <FormField
        label="Styled"
        fieldProps={{ name: 'styled', className: 'my-custom-class' }}
      />,
    );
  ...
  it('applies wrapper className', () => {
    const { container } = render(
      <FormField label="Wrapped" className="wrapper-class" fieldProps={{ name: 'wrapped' }} />,
    );
