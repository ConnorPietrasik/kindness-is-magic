...
vi.mock('axios', () => {
  ...
  mockAxiosInstance = vi.fn().mockResolvedValue({ data: null });
...
// Helper: resolve a mock call with .data
...
describe('admin referrer API functions', () => {
  ...
  it('adminUpdateReferrer — PATCH /api/admin/referrers/:id', async () => {
    const body = { email: 'updated@r.com' };
    mockAxiosInstance.patch.mockResolvedValueOnce({ data: { id: 5, email: 'updated@r.com' } });
...
describe('admin family API functions', () => {
  ...
  it('adminUpdateFamily — PATCH /api/admin/families/:id', async () => {
    const body = { name: 'Jones' };
    mockAxiosInstance.patch.mockResolvedValueOnce({ data: { id: 3, name: 'Jones' } });
...
describe('family self API functions', () => {
  ...
  it('patchFamilyMe — PATCH /api/family/me', async () => {
    const body = { name: 'Updated Family' };
    mockAxiosInstance.patch.mockResolvedValueOnce({ data: { id: 1 } });
