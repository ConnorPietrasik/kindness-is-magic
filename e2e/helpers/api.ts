...
export async function listWishesViaApi(
...
): Promise<{ wishes: Array<{ id: number; type: string; description: string; assigned_to_id: number | null; purchased_at: string | null }>; total: number }> {
  const params = new URLSearchParams();
  ...
  return resp.json() as Promise<{
    wishes: Array<{ id: number; type: string; description: string; assigned_to_id: number | null; purchased_at: string | null }>;
    total: number;
  }>;
}
