...
Revision ID: 364525cb1d99
Revises:
Create Date: 2026-07-29 05:38:33.599166
...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_referrer_approved_by_admin_id", "referrer", "users", ["approved_by_admin_id"], ["id"], ondelete="SET NULL")

    # --- Remaining tables (all dependencies now satisfied) ---
    op.create_table(
